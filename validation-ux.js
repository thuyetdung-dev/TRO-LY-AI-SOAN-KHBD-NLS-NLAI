/* validation-ux.js — V28: giao diện kiểm định, không can thiệp luồng gửi tài liệu. */
(function(){
'use strict';
...
function refresh(){addJumps();status();const tag=$('buildTag'),label='2026-09-15 · V28';if(tag&&tag.textContent!==label)tag.textContent=label}
