...
Phiên bản hiện tại: **V28.0** — số hiệu nằm ở `APP_BUILD` trong `app.js` và hiện trên thanh
...
Bộ kiểm tra hiện có hơn 130 phép thử về công thức Toán, đồ thị, bảng biến thiên, bảng xét dấu,
